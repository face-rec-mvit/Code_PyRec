...
\item{Various Face-Recognition algorithms like SIFT (Scale Invariant Feature Transform) , LPP (Locality Preserving Projections) and PCA (Principle Component Analysis) which perform the actual recognition. (These algorithms are a representative set, many more such algorithms can be implemented.)
\end{enumerate}
\end{quote}
