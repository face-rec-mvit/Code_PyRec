1.Different algorithms tackle different face recognition challenges tp varying
accuracy.
...
Now we note down the K Parameters that characterise this experiment.
...
(preferrably small number K) set of parameters P1,P2..Pk such that we can
