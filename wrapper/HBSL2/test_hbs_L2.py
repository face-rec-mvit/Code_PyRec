...
def return_recognized(test_image_hist,trained_image_hists):
	...
	for i in range(len(trained_image_hists)):
		test_image_hist=numpy.array(test_image_hist)
		taken=numpy.array(trained_image_hists[i])

		## Uncomment following lines to print the details of test_image and image being evaluated among the trained ones 		
		...
		# Uncomment following lines to print the difference taken

		#print "printing difference"
		#print t
		
		# Only this line is changed b/w L1 and L2 differences. 
		# L1 : Just normal difference
		...
		#temp_diff.append(numpy.sqrt(sum(numpy.array(test_image_hist)-numpy.array(trained_image_hists[i])**2)))
	
	## Uncomment following lines to print the difference list details
